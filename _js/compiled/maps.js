...
(function() {
  ...
  brandedMap = (function() {
    ...
    brandedMap.name = 'brandedMap';

    function brandedMap(target) {
      var cloudmade, cloudmadeUrl, targetLatLng;
      target.css({
    ...
    brandedMap.prototype.adjustLatLng = function(latlng, zoom) {
      var destination, origin, shiftBy;
    ...
    brandedMap.prototype.adjustForResults = function(latlng, zoom) {
      var destination, origin, shiftBy, widthDiff;
      origin = this.map.unproject(new L.Point(0, 0), zoom);
